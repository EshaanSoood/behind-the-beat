      ...
      >
        ...
        <div className="review-strip-text flex-1 flex flex-col" data-role="text-block">
          ...
          <div className="review-strip-button mt-4 flex justify-center md:mt-auto" role="presentation">
            <div
              className="button-trapezoid surface-chamfer inline-flex items-center justify-center px-4 py-2 text-sm bg-transparent text-brand-pink500 border border-brand-pink100 transition-colors duration-150 md:group-hover:bg-brand-pink100/20"
            >
